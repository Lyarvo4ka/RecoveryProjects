...
namespace DataBasesNet
{
    class SqlDataBases
    {
        ...
        public bool TestTable(SqlConnection connection , string tableName)
        {
            ...
            string select_table = "SELECT * FROM[beercraft2].[dbo].[" + tableName + "]";
        ...
        public void TestTables()
        {
            ...
            try
            {
                ...
                connetionString = "Data Source=CVI-PROG\\MSSQLSERVER_2014;Initial Catalog=beercraft2;User ID=sa;Password=Admin123";
                connection = new SqlConnection(connetionString);
                connection.Open();

                allTables_ = GetAllTables(connection , "beercraft2");
                connection.Close();
        ...
        public List<ColumnType> GetTableColunmType(string dbName, string tableName)
        {
            ...
            SqlConnection connection;
            string connetionString = "Data Source=CVI-PROG\\MSSQLSERVER_2014;Initial Catalog=" + dbName + "; User ID=sa;Password=Admin123";
            connection = new SqlConnection(connetionString);
...
//                    Console.ReadLine();
        ...
        public bool UpdateNullsIfExist(List<ColumnType> columnTypes, string tableName)
        {
            ...
            foreach (var columType in columnTypes)
            {
                ...
                {
                   // if (columType.column_name_ == "_Fld448")
                    {
                        try
                        {
                            connection_.Open();
...
*/
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // string[] Tables = System.IO.File.ReadAllLines(@"z:\47732\bad_tables.txt");
            string database_name = "beercraft2_new";
            ...
            // foreach (var tableName in Tables)
            {
                ...
                string tableName = "_AccRg439";
                var col_types = sql_bases.GetTableColunmType(database_name, tableName);

                SqlDataBases sql_updater = new SqlDataBases();
                var connString = sql_bases.CreateConnectionString("CVI-PROG\\MSSQLSERVER_2014", database_name, "sa", "Admin123");
                sql_updater.CreateConnection(connString);
                sql_updater.UpdateNullsIfExist(col_types, tableName);
            }
